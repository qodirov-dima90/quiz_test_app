...
import { Flex, LogoContainer, PageCenter, ResizableBox } from '../../styles/Global'
...
const ResultScreen: FC = () => {
  const { result, user } = useQuiz()

  const handleSubmit = async () => {
  

    const correctAnswers = result.reduce((acc, currValue) => currValue.isMatch ? acc + 1 : acc, 0);
    const courseType = correctAnswers < 12 ? "Dasturlash asoslari" : "Preseason";
